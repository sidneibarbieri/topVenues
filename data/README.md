...
The local web and CLI default to `security-20-v5`; manifested profile snapshots are authoritative for reproduction. `data/adjudication/` records evidence-backed identity and title-repair decisions rather than hiding them in implementation code.
