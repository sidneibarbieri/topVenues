...
```bash
git clone --depth 1 --branch v1.11.0 https://github.com/sidneibarbieri/topVenues.git
cd topVenues
...
python -m src.cli --profile security-20-v4 export-hf --release-tag v1.11.0
...
[![TopVenues demonstration](docs/assets/demos/posters/topvenues-demo-v1.5.9.jpg)](https://huggingface.co/datasets/sidneibarbieri/topvenues/resolve/main/assets/demo/topvenues-demo-v1.5.9.mp4)
...
boundary. It was recorded with v1.5.9, before the current visual identity.
